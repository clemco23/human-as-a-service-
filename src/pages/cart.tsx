import CartHumanItem from "../components/molecules/cartItem";
    ...
    const items = [
        {
          ...
          size: 165,
          age: 29,
          personality: "Aventureux",
          price: 300,
          image: "/picture/femme_sourire.jpg",
          isMonthly: false,
        },
        {
          id: 20,
        ...
        <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 bg-white rounded-2xl shadow p-4">
                    {items.map((item) => (
                        <CartHumanItem key={item.id} {...item} />
                    ))}
                </div>
